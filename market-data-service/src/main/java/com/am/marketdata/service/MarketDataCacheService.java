...
public class MarketDataCacheService {
    ...
    public void cacheHistoricalData(String symbol, TimeFrameV1 timeFrame, HistoricalData historicalData) {
        try {
            ...
            if (!points.isEmpty()) {
                ...
                if (timeFrame == TimeFrameV1.DAY || timeFrame == TimeFrameV1.WEEK ||
                        timeFrame == TimeFrameV1.MONTH || timeFrame == TimeFrameV1.YEAR) {
    ...
    public Map<String, HistoricalData> getHistoricalDataFromCacheBatch(List<String> symbols, TimeFrameV1 timeFrame,
        ...
        try {
            ...
            if (timeFrame == TimeFrameV1.DAY || timeFrame == TimeFrameV1.WEEK || timeFrame == TimeFrameV1.MONTH
                    || timeFrame == TimeFrameV1.YEAR) {
