package com.am.marketdata.service.gen;
...
/**
 * Generates the OpenAPI JSON spec by starting the Spring Context
 * and hitting the /v3/api-docs endpoint.
 */
@SpringBootTest
