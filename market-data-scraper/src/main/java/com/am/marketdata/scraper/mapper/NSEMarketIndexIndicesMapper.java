...
public class NSEMarketIndexIndicesMapper {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(NSEMarketIndexIndicesMapper.class);
    ...
    public static MarketIndexIndices convertToMarketIndices(NSEIndexV1 data) {
