 ...
 * Provides endpoints for calculating margin requirements for various trading positions
 */
@RestController
...
public class MarginCalculatorController {
    ...
    private static final Logger log = LoggerFactory.getLogger(MarginCalculatorController.class);
    ...
    @Operation(
        ...
        description = "Calculate SPAN margin, exposure margin, and total margin requirements for a list of positions across different segments"
    )
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Margin calculation successful",
                content = @Content(mediaType = "application/json",
                        schema = @Schema(implementation = MarginCalculationResponse.class))),
    ...
    @Operation(
        ...
        description = "Asynchronously calculate SPAN margin, exposure margin, and total margin requirements for a list of positions across different segments"
    )
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Margin calculation successful",
                content = @Content(mediaType = "application/json",
