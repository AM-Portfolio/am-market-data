...
public class MarketDataController {
        ...
        public ResponseEntity<Map<String, String>> getLoginUrl(
                ...
                return ResponseEntity.ok(marketDataService.getLoginUrl(provider));
        }
        ...
        public ResponseEntity<Object> generateSession(
                ...
                String token = requestToken != null ? requestToken : (requestTokenAlt != null ? requestTokenAlt : code);
                return ResponseEntity.ok(marketDataService.generateSession(token));
        }
        ...
        public ResponseEntity<Map<String, Object>> getQuotes(
                ...
                return ResponseEntity.ok(marketDataService.getQuotes(symbols, timeFrameStr, forceRefresh));
        }
        ...
        public ResponseEntity<Map<String, Object>> getQuotesPost(@RequestBody QuotesRequest request) {
                return ResponseEntity.ok(marketDataService.getQuotesPost(request));
        }
        ...
        public ResponseEntity<?> getOHLC(@RequestBody OHLCRequest request) {
                return ResponseEntity.ok(marketDataService.getOHLC(request));
        }
        ...
        public ResponseEntity<HistoricalDataResponseV1> getHistoricalData(@RequestBody HistoricalDataRequest request) {
                return ResponseEntity.ok(marketDataService.getHistoricalData(request));
        }
        ...
        public ResponseEntity<List<Object>> getSymbolsForExchange(
                ...
                return ResponseEntity.ok(marketDataService.getSymbolsForExchange(exchange));
        }
        ...
        public ResponseEntity<Map<String, Object>> logout() {
                return ResponseEntity.ok(marketDataService.logout());
        }
        ...
        public ResponseEntity<Map<String, Object>> getLivePrices(
                        ...
                        @RequestParam(name = "refresh", defaultValue = "false") boolean forceRefresh) {
                return ResponseEntity.ok(marketDataService.getLivePrices(symbols, indexSymbol, forceRefresh));
        }
        ...
        public ResponseEntity<Map<String, Object>> getLiveLTP(
                        ...
                        @RequestParam(name = "refresh", defaultValue = "false") boolean forceRefresh) {
                return ResponseEntity.ok(marketDataService.getLiveLTP(symbols, timeframe, indexSymbol, forceRefresh));
        }
